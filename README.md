...
- Е.А. Роганов
- М.М. Гаврилин
title: Модификация проекта «Выпуклая оболочка», задача 50
---

## Задача на модификацию

50. Вычисляется угол, под которым выпуклая оболочка видна из начала координат.
    Возвращаемое значение: величина угла в градусах.

### Решение

Вычисляется сумма углов, под которыми из начала координат видны освещённые из
него рёбра (в данном случае понятие освещённости модифицировано — если точка
лежит на ребре, оно не считается освещённым). Если начало координат лежит
внутри оболочки или на её границе угол считается равным нулю.
